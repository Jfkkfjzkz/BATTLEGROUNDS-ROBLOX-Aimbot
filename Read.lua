...
local service = 3557;  -- your service id, this is used to identify your service.

local secret = "13414263-2674-4262-af28-8edf736bcab4";  -- make sure to obfuscate this if you want to ensure security.
...
local Window = Rayfield:CreateWindow({
	Name = "â–¶ Gun Grounds FFA â—€",
	LoadingTitle = "Loading...",
	LoadingSubtitle = "by Leap2476 Youtube ðŸ¥µ",
	ConfigurationSaving = {
		Enabled = true,
...
local Main = Window:CreateTab("working Gun Mods ðŸ”«")
local Aimbot = Window:CreateTab("good Aimbot  ðŸŽ¯")
local ViewModel = Window:CreateTab("Viewmodel ðŸ‘€")
